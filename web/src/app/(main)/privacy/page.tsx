    ...
    >
      <Container className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <LegalList
            items={[
              "「2. 個人情報の収集方法と使用範囲」に定めるみらい議会AIインタビュー機能を通じて当運営者が取得した回答内容を、本人が公開に同意した範囲で公開する場合、および別途定める「みらい議会AIインタビューデータ利用規約」に同意する者であれば誰でもダウンロード可能なオープンデータとして第三者に提供する場合",
              "ユーザー本人の同意がある場合",
        ...
        <section className="space-y-4">
          ...
          <LegalParagraph>
            取得した個人情報および対話ログは、法令に基づき必要な期間（原則7年間）保管した後、適切な方法で廃棄・削除します。なお、本人の同意に基づき公開された回答内容、および個人を特定できないよう加工した上でオープンデータとして提供されたデータなど当運営者が管理していない情報は、廃棄・削除を行うことはできないため、継続して公開・提供されることがあります。
          </LegalParagraph>
        </section>
