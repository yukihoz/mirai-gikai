...
/**
 * クイックリプライのみを LLM で報告資料別に生成するスロット。
...
export const DEFAULT_QUESTIONS_TEMPLATE: readonly DefaultQuestionTemplateEntry[] =
  [
    ...
    },
    {
      ...
      slot: "stance",
      question:
        "この報告資料について、あなたはどんな立場・関わり方に近いですか？",
      follow_up_guide:
    ...
    {
      kind: "fixed",
      question: "今回の報告資料について、現時点でどの程度ご存知ですか。",
      follow_up_guide:
    ...
    },
    {
      kind: "fixed",
      question:
        "今回の報告資料について、全体としてどのように評価していますか。",
    ...
    },
    {
      kind: "fixed",
      question:
        "この報告資料を実際に運用するうえでハードルがあると思いますか？また、影響を受ける側（個人・事業者・組織など）のさまざまなケースが十分に考慮されていると思いますか？",
      follow_up_guide:
