...
const MEETING_BODY_OPTIONS: Array<{ value: MeetingBody; label: string }> = [
  ...
  {
    value: "築地等都市基盤対策特別委員会",
    label: "築地等都市基盤対策特別委員会",
  },
  { value: "地域活性化対策特別委員会", label: "地域活性化対策特別委員会" },
  {
    value: "子ども子育て・高齢者対策特別委員会",
    label: "子ども子育て・高齢者対策特別委員会",
  },
  ...
  {
    // 正式名称は「区制施行８０周年等にぎわいの向上・創出対策特別委員会」だが、
    // enum のラベル上限（63バイト）に収まらないため縮めている
    value: "区制施行80周年等にぎわい創出対策特別委員会",
    label: "区制施行80周年等にぎわい創出対策特別委員会",
  },
  {
