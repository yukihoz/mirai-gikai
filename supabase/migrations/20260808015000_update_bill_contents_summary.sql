-- Update and upsert full bill contents summary and text for walking smoking topic
...
-- Delete old bill contents to guarantee fresh insert for all difficulty levels
DELETE FROM public.bill_contents WHERE bill_id = '82333c65-6fbb-4de1-87c0-62b910fecf4d';
