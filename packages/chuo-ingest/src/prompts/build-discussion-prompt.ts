...
- 議題（区政全般の調査など）についての質疑は、資料に紐づかないので含めないでください

## どの資料の話かの見分け方

発言には \`［資料4への言及］\` のような印を付けてあります。委員が
「まず、資料４について」と資料番号を口に出した回だけに付くので、

- **印が無い発言は、直前に印が付いた資料の続き**として扱ってください。
  理事者の答弁や、同じ委員の追加質問には印が付きません
- 委員が変わったら、その委員が最初に挙げた資料から数え直してください
- どの資料の話か最後まで判断できない発言は、**どれかに割り当てず捨ててください**。
  当てずっぽうで振り分けるより、漏れるほうがましです
