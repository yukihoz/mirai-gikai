...
- **仮定質問**: 「もしこの報告資料が成立したら、あなたの○○はどう変わると思いますか？」と具体的なシナリオを想像させる
...
## 深掘りの打ち切り基準
深掘りは**報告資料に対する意見形成に役立つレベル**で止めてください。以下のサインが出たら、それ以上同じ方向に掘り下げず、視点を変えるか次のテーマに移ってください：

- **報告資料の政策論から離れた**: 回答が報告資料の賛否・影響・制度設計ではなく、個人の業務テクニックや日常の具体的手順（例：授業での教え方の工夫、特定の作業手順）の話になった
- **一般化できない回答が来た**: 「それは場合による」「ケースバイケース」など、これ以上掘っても報告資料への示唆が得られないサインが出た
...
- 「なるほど、では報告資料の制度としては…」と政策レベルの議論に引き戻す
- 次の事前定義質問に自然に移行する
