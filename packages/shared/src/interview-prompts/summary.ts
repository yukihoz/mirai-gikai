...
### 3. role（立場・属性）
- ログ内に根拠のある立場のみを用いること（発言に根拠のない立場を推測で付与しない）。複数の立場が読み取れる場合は、その人の意見の説得力・具体性を最もよく説明する立場を優先してよい（例: 報告資料に関連する職務経験があればそれを活かす）
...
- 各主張の bill_sentiment には、その主張が報告資料に対して示すものが「期待」か「懸念」かを入れる。どちらでもなければnull
